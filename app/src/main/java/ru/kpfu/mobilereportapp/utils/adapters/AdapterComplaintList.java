...
public class AdapterComplaintList extends ArrayAdapter<ComplaintEntity> {
    ...
    public AdapterComplaintList(Activity context, List<ComplaintEntity> list) {
        super(context, R.layout.complaint_layout2, list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.complaint_layout2, null);
