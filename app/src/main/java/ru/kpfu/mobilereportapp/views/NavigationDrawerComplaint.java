...
public class NavigationDrawerComplaint {
    ...
    public Drawer.Result init() {
        ...
        IProfile profile = new ProfileDrawerItem().withIcon(userPic);
        ...
        _drawer = new Drawer()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName(user.getNameUser()).withIcon(FontAwesome.Icon.faw_user),
                        new PrimaryDrawerItem().withName(user.getFacultyUser()).withIcon(FontAwesome.Icon.faw_home),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_custom).withIcon(FontAwesome.Icon.faw_comment),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_all).withIcon(FontAwesome.Icon.faw_comment),
